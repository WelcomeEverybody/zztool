...
`,_sfc_main$A=defineComponent({__name:"debounce",setup(n){const t=()=>{zztool.debounce(()=>{console.log("防抖")},1e3)};return(o,e)=>{const a=resolveComponent("InputText");return openBlock(),createElementBlock(Fragment,null,[createBaseVNode("button",{onClick:e[0]||(e[0]=r=>t())},"点击"),createVNode(a,{contents:strCode$x,show:!1})],64)}}}),strCode$w=`
zztool.throttle(() => {
    console.log('节流');
}, 1000);
...
`,_sfc_main$k=defineComponent({__name:"moneyFormat",setup(n){const t=zztool_umdExports.moneyFormat(money),o=zztool_umdExports.moneyFormat(money,"~","$");return console.log(t,o),(e,a)=>{const r=resolveComponent("InputText");return openBlock(),createBlock(r,{contents:strCode$j})}}}),strCode$i=`
