import{d as l,i,r as _,o as v,a,c as s,b as x,F as O,e as f,u as w,f as d,t as T,s as I,g as L,h as D,j as A,k as F}from"./@vue-BhQ9nhU0.js";import{Z}from"./@zzcpt-C80WVCcs.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const n of e)if(n.type==="childList")for(const m of n.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&r(m)}).observe(document,{childList:!0,subtree:!0});function o(e){const n={};return e.integrity&&(n.integrity=e.integrity),e.referrerPolicy&&(n.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?n.credentials="include":e.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(e){if(e.ep)return;e.ep=!0;const n=o(e);fetch(e.href,n)}})();const R=120,E=30,C=l({__name:"moveBtn",setup(c){const t=i("$ZZTOOL"),o=_(),r=_(!0),e=()=>{const m=t.getRandom(0,window.innerWidth-R),p=t.getRandom(0,window.innerHeight-E);return{x:m,y:p}},n=()=>{if(!r.value)return;const{x:m,y:p}=e(),z=t.getRandomColor(),u=t.getRandomColor();o.value.style.left=m+"px",o.value.style.top=p+"px",o.value.style.backgroundColor=z,o.value.style.color=u};return v(()=>{o.value.addEventListener("mouseenter",n),o.value.addEventListener("click",()=>{alert("我们是匆匆的行者，祝福如春雨，滋润心田间。愿你笑容常开，生活美满甜；事业步步高，前程似锦绣。健康快乐伴你左右，幸福永远与你相伴。")}),window.onresize=n,window.addEventListener("keydown",m=>{m.key===" "&&(r.value=!1)}),n()}),(m,p)=>(a(),s("button",{ref_key:"btn",ref:o,id:"btn"},"空格定身(点击)",512))}}),g=(c,t)=>{const o=c.__vccOpts||c;for(const[r,e]of t)o[r]=e;return o},B=g(C,[["__scopeId","data-v-1c206707"]]),M=[{name:"公共方法",list:[{name:"获取版本号",title:"getVersion",com:"getVersion"},{name:"抛错",title:"error",com:"error"},{name:"防抖",title:"debounce",com:"debounce"},{name:"节流",title:"throttle",com:"throttle"}]},{name:"类型检测",list:[{name:"获取类型",title:"getType",com:"getType"}]},{name:"正则操作",list:[{name:"是否包含xx",title:"regIsHas",com:"regIsHas"},{name:"是否为邮箱",title:"regEmail",com:"regEmail"},{name:"是否为手机号",title:"regPhone",com:"regPhone"},{name:"是否为身份证号",title:"regIdcard",com:"regIdcard"}]},{name:"参数获取",list:[{name:"获取url参数",title:"getUrlParam",com:"getUrlParam"},{name:"参数格式化",title:"paramformat",com:"paramformat"}]},{name:"转类型",list:[{name:"转字符串",title:"toString",com:"toString"},{name:"转数组",title:"toArray",com:"toArray"}]},{name:"工具函数",list:[{name:"获取随机数",title:"getRandom",com:"getRandom"},{name:"获取随机数组",title:"getRandomArray",com:"getRandomArray"},{name:"获取随机颜色",title:"getRandomColor",com:"getRandomColor"},{name:"金额千分位",title:"moneyFormat",com:"moneyFormat"}]},{name:"数据处理",list:[{name:"数据对比",title:"dataEqual",com:"dataEqual"},{name:"对象中是否有空值",title:"dataEmpty",com:"dataEmpty"},{name:"深克隆",title:"deepClone",com:"deepClone"},{name:"转树形结构",title:"toTree",com:"toTree"},{name:"数据分组",title:"groupBy",com:"groupBy"},{name:"取交/并/差/补",title:"dataMerge",com:"dataMerge"},{name:"数组去重",title:"dataUnique",com:"dataUnique"},{name:"数组去空",title:"dataUnEmpty",com:"dataUnEmpty"},{name:"打乱数组",title:"shuffleArray",com:"shuffleArray"},{name:"dataFindValues",title:"dataFindValues",com:"dataFindValues"}]},{name:"日期",list:[{name:"日期信息",title:"getDateInfo",com:"getDateInfo"},{name:"日期类型",title:"getDateType",com:"getDateType"},{name:"获取日期",title:"getDate",com:"getDate"},{name:"月份天数",title:"getMonthDays",com:"getMonthDays"},{name:"两个日期之间的日期",title:"getBetwenDate",com:"getBetwenDate"},{name:"某日期的近期天数",title:"getDateList",com:"getDateList"},{name:"获取时间段",title:"getTimeStep",com:"getTimeStep"}]}],q={class:"menu"},S={class:"title"},k=["onClick"],U=l({__name:"menu",emits:["change"],setup(c,{emit:t}){const o=t,r=e=>{o("change",e)};return(e,n)=>(a(),s("div",q,[n[0]||(n[0]=x('<div class="menu-item" data-v-83227898><div class="title" data-v-83227898>说明</div><div class="item" data-v-83227898>安装(请看控制台)</div><div class="item" data-v-83227898>react/vue都可以使用</div><div class="item" data-v-83227898>输出结果请看控制台</div></div>',1)),(a(!0),s(O,null,f(w(M),(m,p)=>(a(),s("div",{class:"menu-item",key:p},[d("div",S,T(m.name),1),(a(!0),s(O,null,f(m.list,(z,u)=>(a(),s("div",{class:"item",key:u,onClick:b=>r(z)},T(z.name),9,k))),128))]))),128))]))}}),V=g(U,[["__scopeId","data-v-83227898"]]),P={class:"w-full h-full",name:"",id:""},h=l({__name:"getVersion",setup(c){const o=i("$ZZTOOL").v;return console.log(o),(r,e)=>(a(),s("textarea",P,`\r
...
<script lang="ts" setup>\r
  ...
  zztool.error('抛出错误');\r
<\/script>\r
`))}}),Y=l({__name:"debounce",setup(c){const t=i("$ZZTOOL"),o=()=>{t.debounce(()=>{console.log("防抖")},1e3)};return(r,e)=>(a(),s(O,null,[d("button",{onClick:o},"点击"),e[0]||(e[0]=d("textarea",{class:"w-full h-50",name:"",id:""},`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`,-1))],64))}}),G=l({__name:"throttle",setup(c){const t=i("$ZZTOOL"),o=()=>{t.throttle(()=>{console.log("节流")},1e3)};return(r,e)=>(a(),s(O,null,[d("button",{onClick:o},"点击"),e[0]||(e[0]=d("textarea",{class:"w-full h-50",name:"",id:""},`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),mt={class:"w-full h-50",name:"",id:""},pt="111111111111111111",zt="46516546549874654x",dt=l({__name:"regIdcard",setup(c){const t=i("$ZZTOOL"),o=Array.from([pt,zt]);for(let r=0;r<o.length;r++){const e=o[r],n=t.regIdcard(e);console.log(n)}return(r,e)=>(a(),s("textarea",mt,`\r
--- 本方法验证的是真实有效的身份证号码 ---\r
------------------------------------------\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
...
<\/script>\r
`))}}),Lt={class:"w-full h-50",name:"",id:""},ht="1,2,3,4,5",$t="1-2-3-4-5",yt="12345",vt=l({__name:"toArray",setup(c){const t=i("$ZZTOOL"),o={a:1,b:2},r=[1,2,3],e=t.toArray(o),n=t.toArray(r),m=t.toArray(ht),p=t.toArray($t,"-"),z=t.toArray(yt);return console.log(e,n,m,p,z),(u,b)=>(a(),s("textarea",Lt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),Rt={class:"w-full h-full",name:"",id:""},Et=l({__name:"dataEqual",setup(c){const t=i("$ZZTOOL"),o={a:2,b:1,c:{d:1}},r={a:2,b:2,c:{d:2}},e=t.dataEqual(o,r);return console.log(e),(n,m)=>(a(),s("textarea",Rt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
  ...
  console.log(data)\r
<\/script>\r
`))}}),Ct={class:"w-full h-full",name:"",id:""},Bt=l({__name:"dataEmpty",setup(c){const t=i("$ZZTOOL"),o={a:2,b:1,c:{d:1}},r={a:2,b:1,c:{d:1,e:[]}},e=t.dataEmpty(o),n=t.dataEmpty(r);return console.log(e,n),(m,p)=>(a(),s("textarea",Ct,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),Mt={class:"w-full h-full",name:"",id:""},qt=l({__name:"deepClone",setup(c){const t=i("$ZZTOOL"),o={a:2,b:1,c:{d:1}},r=t.deepClone(o);return console.log(o==r),(e,n)=>(a(),s("textarea",Mt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<script lang="ts" setup>\r
  ...
  console.log(datas)\r
<\/script>\r
`))}}),Pt={class:"w-full h-full",name:"",id:""},Ht=l({__name:"dataMerge",setup(c){const t=i("$ZZTOOL"),o=[1,2,3,4,5],r=[4,5,6,7,8],e=t.dataMerge(o,r,1),n=t.dataMerge(o,r,2),m=t.dataMerge(o,r,3),p=t.dataMerge(o,r,4);return console.log(e),console.log(n),console.log(m),console.log(p),(z,u)=>(a(),s("textarea",Pt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),ro={class:"w-full h-full",name:"",id:""},eo=l({__name:"getDate",setup(c){const t=i("$ZZTOOL");return console.log(t.getDate()),console.log(t.getDate("2023-6-15")),console.log(t.getDate("Y/M/D")),(o,r)=>(a(),s("textarea",ro,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),so={class:"w-full h-full",name:"",id:""},co=l({__name:"getBetwenDate",setup(c){const t=i("$ZZTOOL");return console.log(t.getBetweenDate("2024-06-01","2024-06-15",!0)),console.log(t.getBetweenDate("2024-06-01","2024-06-15")),(o,r)=>(a(),s("textarea",so,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),zo={class:"w-full h-full",name:"",id:""},uo=l({__name:"shuffleArray",setup(c){const t=i("$ZZTOOL"),o=t.getRandomArray(10,0,10);return console.log(t.shuffleArray(o)),console.log(t.shuffleArray(o)),(r,e)=>(a(),s("textarea",zo,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
  ...
  console.log(zztool.shuffleArray(arr));\r
<\/script>\r
`))}}),Oo={style:{display:"flex"}},_o={style:{width:"100%",padding:"10px"}},Zo=l({__name:"App",setup(c){const t=I(h),o={getVersion:h,error:N,debounce:Y,throttle:G,getType:X,regIsHas:tt,regEmail:at,regPhone:it,regIdcard:dt,getUrlParam:_t,paramformat:gt,toString:Tt,toArray:vt,getRandom:jt,getRandomArray:wt,getRandomColor:Dt,moneyFormat:Ft,dataEqual:Et,dataEmpty:Bt,deepClone:qt,toTree:kt,groupBy:Vt,dataMerge:Ht,dataUnique:Yt,dataUnEmpty:Kt,dataFindValues:Xt,getDateInfo:Qt,getDateType:oo,getDate:eo,getMonthDays:ao,getBetwenDate:co,getDateList:io,getTimeStep:po,shuffleArray:uo},r=m=>{console.log(`%c${m.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),t.value=o[m.com]},e=_(),n=_();return v(()=>{e.value=document.getElementById("dialog"),n.value=document.querySelector(".closeBtn"),e.value.showModal(),n.value.addEventListener("click",function(){e.value.close()})}),(m,p)=>(a(),s(O,null,[L(B),d("div",Oo,[L(V,{onChange:r}),d("div",_o,[(a(),D(A(t.value)))]),p[0]||(p[0]=x(`<dialog id="dialog" data-v-16108437><div class="win" data-v-16108437><div class="container" data-v-16108437><h4 data-v-16108437>安装/使用</h4><code data-v-16108437><pre data-v-16108437>===== Vue
--- install
...
export const tool:ZZTOOL = (() =&gt; {
    return new ZZTOOL();
            ...
            </pre></code><h4 data-v-16108437>说明</h4><ul style="list-style:inside;" data-v-16108437><li data-v-16108437>文档示例输出均在控制台</li><li data-v-16108437>可在控制台中使用 zz.getVersion() 等命令使用该工具库</li></ul></div><button class="closeBtn" data-v-16108437>关 闭</button></div></dialog>`,1))])],64))}}),go=g(Zo,[["__scopeId","data-v-16108437"]]),j=window;j.zz=new Z;j.zz=new Z;F(go).provide("$ZZTOOL",new Z).mount("#app");
//# sourceMappingURL=index-CC5wk-d8.js.map
