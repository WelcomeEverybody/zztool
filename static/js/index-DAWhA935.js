...
<script lang="ts" setup>\r
  ...
  zztool.error('抛出错误');\r
<\/script>\r
`))}}),Y=l({__name:"debounce",setup(c){const t=i("$ZZTOOL"),o=()=>{t.debounce(()=>{console.log("防抖")},1e3)};return(r,e)=>(a(),s(_,null,[z("button",{onClick:o},"点击"),e[0]||(e[0]=z("textarea",{class:"w-full h-50",name:"",id:""},`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`,-1))],64))}}),G=l({__name:"throttle",setup(c){const t=i("$ZZTOOL"),o=()=>{t.throttle(()=>{console.log("节流")},1e3)};return(r,e)=>(a(),s(_,null,[z("button",{onClick:o},"点击"),e[0]||(e[0]=z("textarea",{class:"w-full h-50",name:"",id:""},`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),ut={class:"w-full h-50",name:"",id:""},_t="http://www.baidu.com?a=1&b=2",Ot=l({__name:"getUrlParam",setup(c){const o=i("$ZZTOOL").getUrlParam(_t);return console.log(o),(r,e)=>(a(),s("textarea",ut,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),Bt={class:"w-full h-full",name:"",id:""},St=l({__name:"deepClone",setup(c){const t=i("$ZZTOOL"),o={a:2,b:1,c:{d:1}},r=t.deepClone(o);return console.log(o==r),(e,n)=>(a(),s("textarea",Bt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),kt={class:"w-full h-full",name:"",id:""},qt=l({__name:"toTree",setup(c){const t=i("$ZZTOOL");var o=[{id:1,parentId:null,name:"Item 1"},{id:2,parentId:1,name:"Item 1.1"},{id:3,parentId:1,name:"Item 1.2"},{id:4,parentId:2,name:"Item 1.1.1"},{id:5,parentId:null,name:"Item 2"}];const r=t.toTree(o,"parentId");return console.log(r),(e,n)=>(a(),s("textarea",kt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
  ...
  console.log(tree)\r
<\/script>\r
`))}}),Ut={class:"w-full h-full",name:"",id:""},Pt=l({__name:"groupBy",setup(c){const t=i("$ZZTOOL");var o=[{id:1,parentId:2,name:"Item 1"},{id:2,parentId:1,name:"Item 1.1"},{id:3,parentId:1,name:"Item 1.2"},{id:4,parentId:2,name:"Item 1.1.1"}];const r=t.groupBy(o,"parentId");return console.log(r),(e,n)=>(a(),s("textarea",Ut,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
  ...
  console.log(datas)\r
<\/script>\r
`))}}),Vt={class:"w-full h-full",name:"",id:""},Ht=l({__name:"dataMerge",setup(c){const t=i("$ZZTOOL"),o=[1,2,3,4,5],r=[4,5,6,7,8],e=t.dataMerge(o,r,1),n=t.dataMerge(o,r,2),m=t.dataMerge(o,r,3),p=t.dataMerge(o,r,4);return console.log(e),console.log(n),console.log(m),console.log(p),(d,u)=>(a(),s("textarea",Vt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),zo={style:{display:"flex"}},uo={style:{width:"100%",padding:"10px"}},_o=l({__name:"App",setup(c){const t=I(h),o={getVersion:h,error:N,debounce:Y,throttle:G,getType:X,regIsHas:tt,regEmail:at,regPhone:it,regIdcard:zt,getUrlParam:Ot,paramformat:gt,toString:Tt,toArray:vt,getRandom:jt,getRandomArray:wt,getRandomColor:Dt,moneyFormat:Ft,dataEqual:Rt,dataEmpty:Mt,deepClone:St,toTree:qt,groupBy:Pt,dataMerge:Ht,dataUnique:Yt,dataUnEmpty:Kt,dataFindValues:Xt,getDateInfo:Qt,getDateType:oo,getDate:eo,getMonthDays:ao,getBetwenDate:co,getDateList:io,getTimeStep:po},r=m=>{console.log(`%c${m.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),t.value=o[m.com]},e=O(),n=O();return v(()=>{e.value=document.getElementById("dialog"),n.value=document.querySelector(".closeBtn"),e.value.showModal(),n.value.addEventListener("click",function(){e.value.close()})}),(m,p)=>(a(),s(_,null,[L(M),z("div",zo,[L(P,{onChange:r}),z("div",uo,[(a(),D(A(t.value)))]),p[0]||(p[0]=x(`<dialog id="dialog" data-v-ee312920><div class="win" data-v-ee312920><div class="container" data-v-ee312920><h4 data-v-ee312920>安装/使用</h4><code data-v-ee312920><pre data-v-ee312920>--- install
npm install @zzcpt/zztool
npm install @zzcpt/zztool@1.1.3
--- main.ts
...
const zztool:ZZTOOL = inject(&#39;$ZZTOOL&#39;) as ZZTOOL;
            </pre></code><h4 data-v-ee312920>说明</h4><ul style="list-style:inside;" data-v-ee312920><li data-v-ee312920>文档示例输出均在控制台</li><li data-v-ee312920>可在控制台中使用 zz.getVersion() 等命令使用该工具库</li></ul></div><button class="closeBtn" data-v-ee312920>关 闭</button></div></dialog>`,1))])],64))}}),Oo=g(_o,[["__scopeId","data-v-ee312920"]]),j=window;j.zz=new Z;j.zz=new Z;F(Oo).provide("$ZZTOOL",new Z).mount("#app");
//# sourceMappingURL=index-DAWhA935.js.map
