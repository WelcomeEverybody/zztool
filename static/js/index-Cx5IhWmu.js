...
}`,_sfc_main$s=defineComponent({__name:"regEmail",setup(n){return(t,o)=>(openBlock(),createBlock(_sfc_main$t,{contents:strCode$r}))}}),strCode$q=`
...
`,_sfc_main$r=defineComponent({__name:"regPhone",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$q})}}}),strCode$p=`
...
`,_sfc_main$q=defineComponent({__name:"regIdcard",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$p})}}}),strCode$o=`
  const url = "http://www.baidu.com?a=1&b=2";
  const param = zztool.getUrlParam(url); // 无参数则会获取url
  console.log(param) // {a: '1', b: '2'}
`,_sfc_main$p=defineComponent({__name:"getUrlParam",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$o})}}}),strCode$n=`
  ...
  console.log(param2);
  console.log(param3);
`,_sfc_main$o=defineComponent({__name:"paramformat",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$n})}}}),strCode$m=`
  const obj = { a: 1, b: 2 };
  const arr = [1, 2, 3];
  ...
  console.log(str1);
  console.log(str2);
`,_sfc_main$n=defineComponent({__name:"toString",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$m})}}}),strCode$l=`
  const obj = { a: 1, b: 2 };
  const arr = [1, 2, 3];
  ...
  console.log(str4);
  console.log(str5);
`,_sfc_main$m=defineComponent({__name:"toArray",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$l})}}}),strCode$k=`
  const random = zztool.getRandom(0,100);
  console.log(random)
`,_sfc_main$l=defineComponent({__name:"getRandom",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$k})}}}),strCode$j=`
  const random = zztool.getRandomArray(100,0,100);
  console.log(random)
`,_sfc_main$k=defineComponent({__name:"getRandomArray",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$j})}}}),strCode$i=`
...
`,_sfc_main$j=defineComponent({__name:"getRandomColor",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$i})}}}),money=1e6,strCode$h=`
const money = 1000000;
...
`,_sfc_main$i=defineComponent({__name:"moneyFormat",setup(n){const t=zztool_umdExports.moneyFormat(money),o=zztool_umdExports.moneyFormat(money,"~","$");return console.log(t,o),(e,a)=>{const r=resolveComponent("InputText");return openBlock(),createBlock(r,{contents:strCode$h})}}}),strCode$g=`
  ...
  console.log(data2)
  console.log(data3)
`,_sfc_main$h=defineComponent({__name:"dataEqual",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$g})}}}),strCode$f=`
  const obj1 = {a:2,b:1,c:{d:1}};
  ...
  console.log(data1);
  console.log(data2);
`,_sfc_main$g=defineComponent({__name:"dataEmpty",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$f})}}}),strCode$e=`
  const obj1 = {a:2,b:1,c:{d:1}};
  const obj2 = zztool.deepClone(obj1);
  console.log(obj1 == obj2)
  console.log(obj1 === obj2)
`,_sfc_main$f=defineComponent({__name:"deepClone",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$e})}}}),strCode$d=`
  var data = [
  ...
  console.log(tree)
`,_sfc_main$e=defineComponent({__name:"toTree",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$d})}}}),strCode$c=`
var data = [
...
console.log(datas)
`,_sfc_main$d=defineComponent({__name:"groupBy",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$c})}}}),strCode$b=`
...
console.log(data3)
console.log(data4)
`,_sfc_main$c=defineComponent({__name:"dataMerge",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$b})}}}),strCode$a=`
const arr1 = [1,2,3,4,5,5,6];
const data = zztool.uniqueArray(arr1);
console.log(data)
`,_sfc_main$b=defineComponent({__name:"dataUnique",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$a})}}}),strCode$9=`
const arr1 = [1,2,3,4,5,5,'','',6];
console.log(arr1)
const data = zztool.arrayTrim(arr1);
console.log(data)
`,_sfc_main$a=defineComponent({__name:"dataUnEmpty",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$9})}}}),strCode$8=`
const date = zztool.getDateInfo('2023-6-15')
console.log(date)
`,_sfc_main$9=defineComponent({__name:"getDateInfo",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$8})}}}),strCode$7=`
const date = zztool.getDateType('2023-6-15',"Y/M/D")
console.log(date)
`,_sfc_main$8=defineComponent({__name:"getDateType",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$7})}}}),strCode$6=`
...
`,_sfc_main$7=defineComponent({__name:"getDate",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$6})}}}),strCode$5=`
const days = zztool.getMonthDays(2024,6);
console.log(days);
`,_sfc_main$6=defineComponent({__name:"getMonthDays",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$5})}}}),strCode$4=`
console.log(zztool.getBetweenDate('2024-06-01', '2024-06-15',true))
console.log(zztool.getBetweenDate('2024-06-01', '2024-06-15'))
`,_sfc_main$5=defineComponent({__name:"getBetwenDate",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$4})}}}),strCode$3=`
...
`,_sfc_main$4=defineComponent({__name:"getDateList",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$3})}}}),strCode$2=`
...
`,_sfc_main$3=defineComponent({__name:"getTimeStep",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$2})}}}),strCode$1=`
const arr = zztool.getRandomArray(10,0,10);
console.log(zztool.shuffleArray(arr));
console.log(zztool.shuffleArray(arr));
`,_sfc_main$2=defineComponent({__name:"shuffleArray",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode$1})}}}),strCode=`
const number = zztool.getPercentage(10, 100,2);
console.log(number)
`,_sfc_main$1=defineComponent({__name:"getPercentage",setup(n){return(t,o)=>{const e=resolveComponent("InputText");return openBlock(),createBlock(e,{contents:strCode})}}}),_hoisted_1={style:{display:"flex"}},_hoisted_2={style:{width:"100%",padding:"10px"}},_hoisted_3={id:"dialog"},_hoisted_4={class:"win"},_hoisted_5={class:"container"},_hoisted_6={style:{"list-style":"inside"}},_hoisted_7={class:"closeBtn"},_sfc_main=defineComponent({__name:"App",setup(n){const t=shallowRef(_sfc_main$A),o={getVersion:_sfc_main$A,error:_sfc_main$z,debounce:_sfc_main$y,throttle:_sfc_main$x,getType:_sfc_main$w,regIsHas:_sfc_main$v,regEmail:_sfc_main$s,regPhone:_sfc_main$r,regIdcard:_sfc_main$q,getUrlParam:_sfc_main$p,paramformat:_sfc_main$o,toString:_sfc_main$n,toArray:_sfc_main$m,getRandom:_sfc_main$l,getRandomArray:_sfc_main$k,getRandomColor:_sfc_main$j,moneyFormat:_sfc_main$i,dataEqual:_sfc_main$h,dataEmpty:_sfc_main$g,deepClone:_sfc_main$f,toTree:_sfc_main$e,groupBy:_sfc_main$d,dataMerge:_sfc_main$c,dataUnique:_sfc_main$b,dataUnEmpty:_sfc_main$a,getDateInfo:_sfc_main$9,getDateType:_sfc_main$8,getDate:_sfc_main$7,getMonthDays:_sfc_main$6,getBetwenDate:_sfc_main$5,getDateList:_sfc_main$4,getTimeStep:_sfc_main$3,shuffleArray:_sfc_main$2,getPercentage:_sfc_main$1},e=l=>{console.log(`%c${l.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),t.value=o[l.com]},{t:a}=useI18n(),r=ref(),s=ref();return onMounted(()=>{r.value=document.getElementById("dialog"),s.value=document.querySelector(".closeBtn"),s.value.addEventListener("click",function(){r.value.close()})}),(l,i)=>(openBlock(),createElementBlock(Fragment,null,[createVNode(MoveBtn),createBaseVNode("div",_hoisted_1,[createVNode(Menu,{onChange:e}),createBaseVNode("div",_hoisted_2,[(openBlock(),createBlock(resolveDynamicComponent(t.value)))]),createBaseVNode("dialog",_hoisted_3,[createBaseVNode("div",_hoisted_4,[createBaseVNode("div",_hoisted_5,[createBaseVNode("h4",null,toDisplayString(unref(a)("install"))+"/"+toDisplayString(unref(a)("use")),1),i[0]||(i[0]=createBaseVNode("code",null,[createBaseVNode("pre",null,`--- install
npm install @zzcpt/zztool@latest
--- file
import * as zztool from '@zzcpt/zztool';
import { xxx } from '@zzcpt/zztool';

            `)],-1)),createBaseVNode("h4",null,toDisplayString(unref(a)("illustrate")),1),createBaseVNode("ul",_hoisted_6,[createBaseVNode("li",null,toDisplayString(unref(a)("dialog.illustrate1")),1),createBaseVNode("li",null,toDisplayString(unref(a)("dialog.illustrate2")),1)])]),createBaseVNode("button",_hoisted_7,toDisplayString(unref(a)("close")),1)])])])],64))}}),App=_export_sfc(_sfc_main,[["__scopeId","data-v-2c43ac48"]]),widnows=window;widnows.zz=zztool$1;widnows.zztool=zztool$1;const app=createApp(App);app.component("OutPut",_sfc_main$u);app.component("InputText",_sfc_main$t);app.use(i18n);app.mount("#app");
//# sourceMappingURL=index-Cx5IhWmu.js.map
