...
<\/script>\r
`))}}),Xt={class:"w-full h-50",name:"",id:""},v=1e6,Jt=c({__name:"moneyFormat",setup(s){const t=r.moneyFormat(v),e=r.moneyFormat(v,"~","$");return console.log(t,e),(o,a)=>(n(),l("textarea",Xt,`<script lang="ts" setup>\r
  import * as zztool from '@zzcpt/zztool';\r
\r
...
<\/script>\r
`))}}),Pe={style:{display:"flex"}},Be={style:{width:"100%",padding:"10px"}},Se={id:"dialog"},je={class:"win"},Ue={class:"container"},Fe={style:{"list-style":"inside"}},Le={class:"closeBtn"},qe=c({__name:"App",setup(s){const t=M($),e={getVersion:$,error:pt,debounce:gt,throttle:dt,getType:zt,regIsHas:yt,regEmail:wt,regPhone:At,regIdcard:Mt,getUrlParam:St,paramformat:Ut,toString:Lt,toArray:Vt,getRandom:Zt,getRandomArray:Yt,getRandomColor:Kt,moneyFormat:Jt,dataEqual:te,dataEmpty:oe,deepClone:ae,toTree:le,groupBy:ce,dataMerge:me,dataUnique:ge,dataUnEmpty:ue,getDateInfo:ze,getDateType:he,getDate:xe,getMonthDays:be,getBetwenDate:we,getDateList:ve,getTimeStep:Ae,shuffleArray:Ee,getPercentage:Me},o=u=>{console.log(`%c${u.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),t.value=e[u.com]},{t:a}=y(),i=f(),p=f();return T(()=>{i.value=document.getElementById("dialog"),p.value=document.querySelector(".closeBtn"),i.value.showModal(),p.value.addEventListener("click",function(){i.value.close()})}),(u,_)=>(n(),l(z,null,[w(N),m("div",Pe,[w(ct,{onChange:o}),m("div",Be,[(n(),P(B(t.value)))]),m("dialog",Se,[m("div",je,[m("div",Ue,[m("h4",null,d(g(a)("install"))+"/"+d(g(a)("use")),1),_[0]||(_[0]=m("code",null,[m("pre",null,`--- install
npm install @zzcpt/zztool@latest
--- file
import * as zztool from '@zzcpt/zztool';
import { xxx } from '@zzcpt/zztool';

            `)],-1)),m("h4",null,d(g(a)("illustrate")),1),m("ul",Fe,[m("li",null,d(g(a)("dialog.illustrate1")),1),m("li",null,d(g(a)("dialog.illustrate2")),1)])]),m("button",Le,d(g(a)("close")),1)])])])],64))}}),ke=x(qe,[["__scopeId","data-v-4faa9b5c"]]),Ge=window;Ge.zz=U;const C=S(ke);C.use(O);C.mount("#app");
//# sourceMappingURL=index-D4FnV5CJ.js.map
