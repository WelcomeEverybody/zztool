...
<script lang="ts" setup>\r
  ...
  console.log(data)\r
<\/script>\r
`))}}),wt={class:"w-full h-full",name:"",id:""},It=l({__name:"dataEmpty",setup(s){const t=i("$ZZTOOL"),o={a:2,b:1,c:{d:1}},r={a:2,b:1,c:{d:1,e:[]}},e=t.dataEmpty(o),c=t.dataEmpty(r);return console.log(e,c),(m,p)=>(n(),a("textarea",wt,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),oo={class:"w-full h-full",name:"",id:""},ro=l({__name:"getDateList",setup(s){const t=i("$ZZTOOL"),o=t.getDateList(new Date("2024-6-15"),1),r=t.getDateList(new Date("2024-6-15"),2),e=t.getDateList(new Date("2024-6-15"),3);return console.log("前三天：",o),console.log("前一周：",r),console.log("前一月：",e),(c,m)=>(n(),a("textarea",oo,`\r
<script lang="ts" setup>\r
  import { inject } from 'vue';\r
  import ZZTOOL from '@zzcpt/zztool';\r
  const zztool:ZZTOOL = inject('$ZZTOOL') as ZZTOOL;\r
...
<\/script>\r
`))}}),ao={style:{display:"flex"}},so={style:{width:"100%",padding:"10px"}},co=l({__name:"App",setup(s){const t=y(g),o={getVersion:g,error:S,debounce:U,throttle:P,getType:k,regIsHas:G,regEmail:W,regPhone:rt,regIdcard:st,getUrlParam:it,paramformat:pt,toString:dt,toArray:gt,getRandom:Tt,getRandomArray:ht,getRandomColor:yt,moneyFormat:jt,dataEqual:bt,dataEmpty:It,deepClone:Ft,toTree:Ct,groupBy:Rt,dataMerge:Bt,dataUnique:Ut,dataUnEmpty:Vt,dataFindValues:kt,getDateInfo:Nt,getDateType:Yt,getDate:Jt,getMonthDays:Wt,getBetwenDate:to,getDateList:ro,getTimeStep:no},r=e=>{console.log(`%c${e.title}`,"background: #000000; color: #FFD700; border-radius: 3px 0 0 3px;padding:2px 5px"),t.value=o[e.com]};return(e,c)=>(n(),a("div",ao,[x(R,{onChange:r}),z("div",so,[(n(),j(v(t.value)))])]))}});b(co).provide("$ZZTOOL",new w).mount("#app");
//# sourceMappingURL=index-G-HFVnHs.js.map
